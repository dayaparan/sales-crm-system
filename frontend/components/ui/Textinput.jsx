...
const nonErrorTypes = ["date", "number"];
...
const Textinput = ({
  ...
  className = "bg-[#0c1221]  border border-gray-600 rounded p-2 text-sm focus:outline-none focus:ring-2 focus:ring-yellow-400",
  classGroup = "",
  register,
  name,
  readonly,
  ...
  return (
    ...
    >
      {label && (
        <label
          htmlFor={id}
          className={`block capitalize text-gray-200 ${classLabel}  ${
      ...
      <div className={`relative ${horizontal ? "flex-1" : ""}`}>
        ...
        <div className="flex text-xl absolute ltr:right-[14px] rtl:left-[14px] top-1/2 -translate-y-1/2  space-x-1 rtl:space-x-reverse">
          ...
          {error && !nonErrorTypes.includes(type) && (
